...
fig.add_trace(go.line_polar(r=Day_0, theta=categories, fill='toself', name='Day 0'),row=1, col=1)

fig.add_trace(go.line_polar(r=Day_15, theta=categories, fill='toself', name='Day 15'),row=1, col=2)
